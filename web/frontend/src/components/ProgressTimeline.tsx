  ...
  if (ev.event === 'text') {
    return (
      <div className="flex items-start gap-2 py-0.5 group hover:bg-slate-800/50 rounded px-1 -mx-1">
        ...
        <span className="text-slate-300 text-xs leading-relaxed break-words min-w-0 whitespace-pre-wrap">{ev.detail}</span>
        <span className="text-slate-600 text-[10px] font-mono flex-shrink-0 opacity-0 group-hover:opacity-100">
          {formatTime(ev.timestamp)}
        </span>
      </div>
  ...
  if (ev.event === 'thinking') {
    return (
      <div className="flex items-start gap-2 py-0.5 group hover:bg-slate-800/50 rounded px-1 -mx-1">
        ...
        <span className="text-purple-400 pt-0.5 flex-shrink-0">
          <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
          </svg>
        </span>
        <span className="text-purple-300/70 text-xs leading-relaxed break-words min-w-0 italic">{ev.detail}</span>
        <span className="text-slate-600 text-[10px] font-mono flex-shrink-0 opacity-0 group-hover:opacity-100">
          {formatTime(ev.timestamp)}
        </span>
      </div>
